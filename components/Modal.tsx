...
import ReactPlayer from "react-player/lazy"; // YT: 1:57:25
  ...
  useEffect(() => {
    ...
    async function fetcMovie() {
      const data = await fetch(
        ...
        }&language=en-US&append_to_response=videos` // YT: (1:38:00)
  ...
  return (
    ...
    >
      <>
        <button
          onClick={handleClose}
          className="modalButton hover:bg-[#181818] absolute !z-40 right-5 top-5 h-9 w-9 border-none bg-[#181818]"
        >
          <XMarkIcon className="h-6 w-6" />
        </button>
        <div className="relative pt-[56.25%]">
          <ReactPlayer
            url={`https://www.youtube.com/watch?v=${trailer}`} // Add key
            width="100%"
            height="100%"
